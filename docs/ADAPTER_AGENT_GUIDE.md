...
- [src/omnichain_eval/adapters/base.py](../src/omnichain_eval/adapters/base.py)
- [src/omnichain_eval/schema.py](../src/omnichain_eval/schema.py)
- [src/omnichain_eval/prompting.py](../src/omnichain_eval/prompting.py)
- [src/omnichain_eval/cli.py](../src/omnichain_eval/cli.py)
- [src/omnichain_eval/experiments.py](../src/omnichain_eval/experiments.py)
- [configs/examples/run_eval_adapter.toml](../configs/examples/run_eval_adapter.toml)
- [configs/examples/run_eval_main.toml](../configs/examples/run_eval_main.toml)
- [configs/examples/run_eval_custom_protocol.toml](../configs/examples/run_eval_custom_protocol.toml)
- [README.md](../README.md)
...
The adapter receives [ModelInput](../src/omnichain_eval/schema.py):

- `model_input.sample`: full [PreparedSample](../src/omnichain_eval/schema.py)
...
- `load_prepared_samples()` rewrites `sample.frame_files` to absolute paths at runtime in [src/omnichain_eval/prepare.py](../src/omnichain_eval/prepare.py).
...
For `Spatial_Imagination` downstream evaluation, the framework automatically builds history in [build_chain_history()](../src/omnichain_eval/prompting.py).
...
This is verified in [tests/test_run_eval_resume.py](../tests/test_run_eval_resume.py).
...
- add one adapter module under [src/omnichain_eval/adapters](../src/omnichain_eval/adapters)
...
The framework loads existing rows, backfills state, and skips already completed samples in [src/omnichain_eval/cli.py](../src/omnichain_eval/cli.py).
